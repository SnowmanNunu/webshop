  ...
  <div id="center">
    ...
    <div id="center_middle">
      ...
      <div class="chknumber">
        ...
        <img src="/index.php/Admin/Manager/verifyImg" id="safecode"  width="57" height="20" style="vertical-align:middle;" onclick="this.src='/index.php/Admin/Manager/verifyImg/'+Math.random()"/>
      </div>
    </div>
